...
grep 'ref=373ed4339eb68985b85762715aba3fbfa136ac51' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=373ed4339eb68985b85762715aba3fbfa136ac51[a-z0-9]*/${root}\/\2/g" "${file}"
done
